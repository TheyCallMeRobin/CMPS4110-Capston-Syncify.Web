     ...
     const uniqueName = New Shopping List - ${formattedDate};
      ...
      userId: user.id,
        ...
        */
        ...
        if (response?.data) {
            toast.success("Shopping list created successfully!", { position: "top-right", autoClose: 3000 });
            navigate(`/shopping-list-items/${response.data.id}`);
        } else {
            toast.error("Failed to create shopping list. Please try again.", { position: "top-right", autoClose: 3000 });
        }
    };
        ...
        <div className={'card mb-4 shadow dashb'}>
            ...
            <div className={'card-body'}>
                <div className={'vstack gap-3'}>
                    ...
                    <div>
                        <Link className={'icon-link'} style={linkStyle} to={'/family-management'}>
                            <FaPlus />
                    ...
                    <div>
                        <Link className={'icon-link'} style={linkStyle} to={'/create-recipe'}>
                            <FaPlus />
                            Create Recipe
                        </Link>
                    </div>
